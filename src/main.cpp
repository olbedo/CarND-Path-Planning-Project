...
int main() {
  ...
  Vehicle vehicle(map_waypoints_s, map_waypoints_x, map_waypoints_y,
    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2')
    {
      ...
      if (s != "") 
      {
        ...
        if (event == "telemetry") 
        {
          ...
          double car_speed = j[1]["speed"];	// m/s 
          ...
          // update vehicle instance with new data from simulator
          ...
          // chose next state and calculate its trajectory
          vector<vector<double>> trajectory = vehicle.choose_next_state();
